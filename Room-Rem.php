...
?>
    ...
    <link rel="stylesheet" href="css/Room-Rem.css">
    </head>
...
<body>
    ...
    <main>
        ...
        <table class="room-tables" id="Room_Details">
            <tr>
                <th class="heading">Rooms Allocated</th>
                <th class="heading">Type</th>
                <th class="heading">Patient ID</th>
                <th class="heading">Patient Name</th>
                <th class="heading">Nurse ID</th>
                <th class="heading">Nurse Name</th>
            </tr>
            <?php if($avail_flag == 1)
                $avail->Show_Alo_Rooms($conn);
            else
                echo "<tr>";
        ...
        <form class = "emp-add-form" method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>">
            ...
            <input id = "allocate-room" name = "allocate-room" type="submit" value="Deallocate">
        </form>
